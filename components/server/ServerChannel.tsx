      ...
      {channel.name !== "general" && role !== memberRole.GUEST && (
        <div className="ml-auto flex items-center gap-x-2">
          <ActionTooltip label="Edit">
            <Edit className=" hidden group-hover:block text-zinc-500 dark:text-zinc-600 size-4 dark:hover:text-zinc-300 transition" />
          </ActionTooltip>
          <ActionTooltip label="Delete">
            <Trash className=" hidden group-hover:block text-zinc-500 dark:text-zinc-600 size-4 dark:hover:text-zinc-300 transition" />
          </ActionTooltip>
        </div>
      )}
